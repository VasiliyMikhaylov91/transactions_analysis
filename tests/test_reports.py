...
def test_file_record() -> None:
    ...
    @file_record()
    def file_record_test() -> str:
        return "test"

    @file_record("test.txt")
    def file_record_test2() -> str:
        return "test2"
...
def test_spending_by_weekday(test_df: pd.DataFrame) -> None:
...
def test_spending_by_workday(test_df: pd.DataFrame) -> None:
